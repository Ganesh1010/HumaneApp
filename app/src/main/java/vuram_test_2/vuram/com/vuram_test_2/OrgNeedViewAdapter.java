...
public class OrgNeedViewAdapter extends RecyclerView.Adapter<OrgNeedViewAdapter.ViewHolder> {
    ...
    @Override
    public OrgNeedViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(OrgNeedViewAdapter.ViewHolder holder, int position) {
