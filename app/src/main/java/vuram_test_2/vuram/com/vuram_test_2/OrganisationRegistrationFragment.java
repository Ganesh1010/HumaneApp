...
public class OrganisationRegistrationFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        org_linearLayout= (LinearLayout) v.findViewById(R.id.org_reg_linear_layout);
    ...
    //    orgType = Integer.parseInt(orgTypeName.substring(1));
        ...
        CommonUI.internetConnectionChecking(getActivity(),org_linearLayout,new OrganisationAccount());
    ...
    public void onSignupFailed() {
        ...
        CommonUI.internalValidation(getActivity(),org_linearLayout,"Invalid Password");
            ...
            if (response != null)
                if (response.getStatusLine().getStatusCode() == 200 || response.getStatusLine().getStatusCode() == 201) {
                   // Toast.makeText(landingPage, "Registration Successful.Kindly Login to continue", Toast.LENGTH_LONG).show();
                    ...
                    CommonUI.internalValidation(getActivity(),org_linearLayout,"Registration Successful");
